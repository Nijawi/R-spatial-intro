...
You can make a static, publication-quality map with `tmap` as well if you change the tmap_mode('view') to tmap_mode('plot'). You can find that in the original version of [this tutorial by Christina Buelow](https://r-spatial-intro.netlify.app/#making-a-publication-quality-map).
